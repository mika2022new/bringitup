...
var Difference = /*#__PURE__*/function () {
  function Difference(officer, counter, items) {
    ...
    value: function bindTriggers() {
      ...
      this.officer.querySelector('.plus').addEventListener('click', function () {
        if (_this.counter !== _this.items.length - 2) {
          ...
          _this.items[_this.counter].classList.add('animated');

          _this.items[_this.counter].classList.add('slideInDown');

          _this.counter++;
        } else {
          _this.items[_this.counter].style.display = 'flex';

          _this.items[_this.items.length - 1].classList.add('animated');

          _this.items[_this.items.length - 1].classList.add('slideOutDown'); // this.items[this.items.length - 1].remove();
...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./slider */ "./src/js/modules/slider/slider.js");
...
var MainSlider = /*#__PURE__*/function (_Slider) {
  ...
  return MainSlider;
}(_slider__WEBPACK_IMPORTED_MODULE_13__["default"]);
...
var Slider = /*#__PURE__*/_createClass(function Slider() {
  ...
  this.container = document.querySelector(container); // this.slides =  this.container.children;

  try {
    this.slides = this.container.children;
  } catch (e) {} // this.slides = Array.from(this.slides);
  ...
  this.slideIndex = 1; // console.log("Slides", this.slides);
});
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init(); // const player = new VideoPlayer('.showup .play', '.overlay')
  // player.init();
  ...
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', 0, '.officer__card-item').init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', 0, '.officer__card-item').init();
